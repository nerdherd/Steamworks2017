...
public class Gearbox {
	...
	public void executeProfile(double maxVelocity, double maxAcceleration, double distance) {
		...
		m_profile = new MotionProfile(maxVelocity, maxAcceleration, distance);
