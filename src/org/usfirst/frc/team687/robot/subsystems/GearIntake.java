...
import org.usfirst.frc.team687.robot.commands.gearintake.IntakePositionHold;
...
public class GearIntake extends Subsystem {
	...
	public GearIntake() {
		...
		m_gearArtic.changeControlMode(TalonControlMode.MotionMagic);
		m_gearArtic.setMotionMagicAcceleration(GearIntakeConstants.kGearIntakeAcceleration);
		m_gearArtic.setMotionMagicCruiseVelocity(GearIntakeConstants.kGearIntakeVelocity);
	...
	public void setPosHold(double pos) {
	...
	protected void initDefaultCommand() {
		setDefaultCommand(new IntakePositionHold(GearIntakeConstants.kGearIntakeUpPos));
	}
}
