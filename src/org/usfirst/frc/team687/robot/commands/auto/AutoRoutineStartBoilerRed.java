...
public class AutoRoutineStartBoilerRed extends CommandGroup {
	public AutoRoutineStartBoilerRed() {
		...
		addSequential(new DriveTurnToAngle(DriveConstants.kAngleBoilerAutoRed, 1));
