...
public class AutoRoutineStartLoadingRed extends CommandGroup {
	
	public AutoRoutineStartLoadingRed() {
		...
		addSequential(new DriveDistance(DriveConstants.kDistanceFeederAuto2, 1000, 750, 0));
		// WIGGLE
